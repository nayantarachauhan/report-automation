...
shift = Argument_list[1]
fromDate = Argument_list[2]
fromTime = Argument_list[3]
toDate = Argument_list[4]
toTime = Argument_list[5]
...
NA_reasons_query = "SELECT error_desc FROM error_reasons WHERE primary_type = 'NA' AND created_at >= %s AND created_at <= %s GROUP BY 1"
